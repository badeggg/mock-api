 ...
 */
'use strict'
exports[`test/mock3.js TAP response js result 2, export the response > js export array 1`] = `
Array [
  1,
  null,
  Object {
...
exports[`test/mock3.js TAP response js result 2, export the response > js export object 1`] = `
Object {
  "a": 12,
}
`
...
exports[`test/mock3.js TAP response js result 2, export the response > log warnings 1`] = `
Array []
`
